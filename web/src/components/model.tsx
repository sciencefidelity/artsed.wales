...
const Model = ({
  ...
  <section className="modelSection">
    ...
    <div className="vennContainer">
      <div className="vennText">
        <h2 className="vennHeading">{model1}</h2>
        <p className="vennP1">{model2}</p>
        <p>{model3}</p>
        <p>{model4}</p>
      </div>
