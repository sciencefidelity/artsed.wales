...
declare module "@mailchimp/mailchimp_marketing" {
  ...
  export namespace accountExports {
    ...
    // https://mailchimcom/developer/marketing/api/account-exports/get-account-export-info/
  ...
  export namespace authorizedApps {
    ...
    // https://mailchimcom/developer/marketing/api/authorized-apps/get-authorized-app-info/
    function get(
      app_id: string,
      fields?: string[],
      exculde_fields?: string[]
  ...
  export namespace automations {
    ...
    function startAllEmails(workflow_id: string): Promise<void>
    // https://mailchimp.com/developer/marketing/api/automation/pause-automation-emails/
    function pauseAllEmails(workflow_id: string)
    // https://mailchimp.com/developer/marketing/api/automation/archive-automation/
    function archive(workflow_id: string)
    // https://mailchimcom/developer/marketing/api/automation-email/list-automated-emails/
    function listAllWorkflowEmails(workflow_id: string)
  }
